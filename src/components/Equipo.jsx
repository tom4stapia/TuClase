      ...
      <div className="bg-gray-200 py-24 sm:py-32" id="nosotros">
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg leading-8 text-justify text-gray-600">Encuentra al profesor que siempre estuviste buscando para acompañar a tu hijo! No dudes en <a href='https://wa.me/56973927173' target="_blank" className="underline"><b>contactarnos</b></a> para resolver tus dudas.</p>
          </div>
            ...
            {people.map((person) => (
              <li key={person.name}>
                <div className="flex items-center gap-x-6">
                  ...
                  <div>
                    <h3 className="text-lg leading-8 tracking-tight text-gray-900"><b>{person.name}</b></h3>
