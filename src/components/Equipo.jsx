        ...
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Encuentra al profesor que siempre estuviste buscando! No dudes en <a href='https://wa.me/56973927173' target="_blank" className="underline">contactarnos</a> para resolver tus dudas.
            </p>
          </div>
