...
export default function LandingPage() {
  return (
    ...
    <div class="flex flex-col justify-center items-center parallax-image">
      ...
      <a href='https://wa.me/56940988254' target="_blank"><button class="bg-indigo-600 text-white font-bold py-2 px-4 rounded mt-8 mb-20">Agenda tu clase con nosotros</button></a>
    </div>
    <Equipo id="nosotros"/>
    <div className='pb-3'>
    ...
    <div className='m-10'><h2 className="text-5xl titulos font-extrabold tracking-tight text-gray-900 justify-center"><a href='https://wa.me/56940988254' target="_blank">Agenda tu clase</a></h2></div>
